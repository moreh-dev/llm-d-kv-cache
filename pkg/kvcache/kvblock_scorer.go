...
//
// ScoringStrategy defaults to LongestPrefixMatch as a safe baseline: it
// preserves HMA bitmask indexing (since ModelConfigs are populated) while
// avoiding the auto-selection of HybridPrefixCacheScorer, which has different
// routing semantics. Operators who want HMA-aware scoring can override by
// setting ScoringStrategy to "" (auto-detect) or HybridPrefixMatch.
